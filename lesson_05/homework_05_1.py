...
sorted_car_data = sorted(filtered_car_data, key=lambda car: car[1][4])
# print(sorted_car_data)

print('\nFive first found elements, sorted by price ascending \nand satisfied search criteria:\n')

for car in sorted_car_data[:5]:
    print(f'{car[0]}: {car[1]}')